  ...
  const featuresData = [
    {
      ...
      title: "Generative AI",
      description:
        "Build custom generative models that create content, designs, and solutions tailored to your specific business needs.",
    },
    {
      icon: BrainIcon,
      title: "Machine Learning",
      description:
        "Implement predictive analytics and pattern recognition systems that learn from your data to drive better business outcomes.",
    },
    {
      icon: BotIcon,
      title: "NLP & Chatbots",
      description:
        "Deploy intelligent conversational interfaces that understand context, intent, and deliver personalized user experiences.",
    },
    {
      icon: ZapIcon,
      title: "AI Agents",
      description:
        "Create autonomous AI agents that can perform tasks, make decisions, and streamline operations across your organization.",
    },
    {
      icon: EyeIcon,
      title: "Computer Vision",
      description:
        "Implement visual recognition systems that can analyze images and video to extract meaningful insights and automate visual tasks.",
    },
    {
      icon: LineChartIcon,
      title: "Deep Learning",
      description:
        "Harness the power of neural networks to solve complex problems and uncover hidden patterns in large datasets.",
    },
  ];

  return (
    <div className="bg-gradient-to-r from-[#10002B] to-[#240046] py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-300 max-w-3xl mx-auto">
            ...
            uncover insights, and supercharge decision-making. From Generative
            AI to NLP and Computer Vision, our solutions are tailored to your
