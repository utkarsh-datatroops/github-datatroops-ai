...
// const BlogPostDetail = (title:any) => {
//   // const { slug } = useParams();
//   console.log("title", title);
//   console.log("title", title.title);
//   const post = blogPosts.find(post => post.slug === title.title);
...
//                 <Link href="/blog" className="inline-flex items-center text-gray-300 hover:text-white mb-4 transition-colors text-sm">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex items-center justify-start md:justify-center">
              <div className="w-full max-w-4xl mx-auto text-left md:text-center">
                <Link
                  ...
                  className="pt-16 inline-flex items-center text-white/90 hover:text-white mb-4 transition-colors text-sm font-medium"
                >
                  <ArrowLeft className="mr-2 h-3 w-3" />
                  Back to Blog
                </Link>
                ...
                <div className="flex flex-col gap-3 text-white/90 mb-4 sm:mb-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-start md:justify-center gap-2 sm:gap-6">
                    ...
                    <div className="flex items-center text-xs sm:text-base">
                      <User className="mr-2 h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
                      {/* <span className="drop-shadow-md">{post.author}</span> */}
                      <span className="drop-shadow-md">DataTroops.ai</span>
                    </div>
                  </div>

                  <div className="flex justify-start md:justify-center">
                    <div className="px-3 py-1 sm:px-4 sm:py-2 bg-white/25 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium border border-white/30 text-white shadow-lg">
                      {/* {post.category} */}
                      Technology
                    </div>
                  </div>
                ...
                {/* Enhanced excerpt with better contrast */}
