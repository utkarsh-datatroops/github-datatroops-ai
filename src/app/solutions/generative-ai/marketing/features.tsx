      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            ...
            cutting-edge features, designed to optimize your content creation
              ...
              >
                <div className="bento-card w-full flex-row gap-6">
                  ...
                  <div className="flex flex-col mt-auto">
                    ...
                    <p className="text-sm md:text-base mt-2 text-muted-foreground">
                      Generate ideas for your content with our AI-powered tools
                      to create engaging posts in seconds.
                    </p>
                  </div>
                </div>
              </MagicCard>
              ...
              >
                <div className="bento-card w-full flex-row gap-6">
                  <div className="flex flex-col mb-auto">
                    ...
                    <p className="text-sm md:text-base mt-2 text-muted-foreground">
                      Connect your favorite tools and platforms to streamline
