      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
            Flexible pricing for AI adoption at every scale
          </h2>
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            Whether you&apos;re exploring AI for the first time or scaling
            enterprise automation — we&apos;ve got a plan for you.
          </p>
        </div>
      </Container>
        ...
        <Container>
          ...
          >
            ...
            <TabsList className="flex w-full justify-center space-x-4">
              <TabsTrigger
                value="monthly"
                className="data-[state=active]:bg-primary data-[state=active]:text-white py-2 px-4 rounded-t-lg data-[state=active]:border-b-2 data-[state=active]:border-primary text-accent-foreground hover:bg-primary/10"
              >
                Monthly
              </TabsTrigger>
              <TabsTrigger
      ...
      >
        {id === "pro" && (
          <div className="max-w-fit min-w-min inline-flex items-center whitespace-nowrap px-1 h-7 rounded-full bg-gradient-to-r from-primary to-violet-500 absolute -top-3 left-1/2 -translate-x-1/2 select-none">
            <span className="flex-1 text-sm px-2 font-medium bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-white bg-[length:250%_100%] animate-background-shine">
              Most Popular
            </span>
          </div>
        )}
