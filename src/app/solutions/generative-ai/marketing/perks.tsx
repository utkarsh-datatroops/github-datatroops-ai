      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            Discover how our generative AI solutions help you unlock new
            efficiencies, automate workflows, and elevate customer experiences —
            all tailored for your industry and goals.
          </p>
        </div>
      </Container>
      <Container>
