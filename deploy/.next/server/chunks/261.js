(exports.id = 261),
  ...
  (exports.modules = {
    ...
    4544: (e, t, s) => {
      Promise.resolve().then(s.t.bind(s, 2994, 23)),
        Promise.resolve().then(s.t.bind(s, 6114, 23)),
        Promise.resolve().then(s.t.bind(s, 9727, 23)),
        Promise.resolve().then(s.t.bind(s, 9671, 23)),
        Promise.resolve().then(s.t.bind(s, 1868, 23)),
        Promise.resolve().then(s.t.bind(s, 4759, 23));
    },
    1740: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 1418)),
        Promise.resolve().then(s.bind(s, 5601)),
        Promise.resolve().then(s.bind(s, 6373)),
        Promise.resolve().then(s.bind(s, 4355));
    },
    8648: (e, t, s) => {
      "use strict";
      s.d(t, { z: () => l });
                      ...
                      (0, a.jsxs)("form", {
                        onSubmit: async (e) => {
                          ...
                          try {
                            ...
                            x(`Failed to send message. Please try later. ${e}`);
                          }
                        },
                        className: "space-y-6",
                        children: [
                ...
                e &&
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      ...
                      a.jsx("div", {
                        className: "absolute-center isolate -z-10",
                        children: a.jsx(n, { className: "size-[350px]" }),
                      }),
                      a.jsx("div", {
                        className: "absolute-center isolate -z-10",
                        children: a.jsx(n, { className: "size-[500px]" }),
                      }),
                      a.jsx("div", {
                        className: "absolute-center isolate -z-10",
                        children: a.jsx(n, { className: "size-[650px]" }),
                      }),
                      a.jsx("div", {
                        className: "absolute-center isolate -z-10",
                        children: a.jsx(n, { className: "size-[800px]" }),
                      }),
                      a.jsx("div", {
                        ...
                        children: (0, a.jsxs)("nav", {
                          ...
                          children: [
                            ...
                            m.map(({ buttonVariant: e, name: t, href: s }) =>
                              a.jsx(
                                i.default,
                                {
                                  href: s,
    ...
    4355: (e, t, s) => {
      ...
      let h = () => {
        let [e, t] = (0, r.useState)(!1),
          ...
          [g, p] = (0, r.useState)(!0),
          [f, b] = (0, r.useState)(!1),
          [j, w] = (0, r.useState)("normal"),
          [y, v] = (0, r.useState)(!1),
          [N, S] = (0, r.useState)(!1),
          [k, T] = (0, r.useState)(""),
          D = "https://datatrooops-ai-chatbot.onrender.com",
          A = (0, r.useRef)(null),
          B = (0, r.useRef)(null),
          I = () =>
            `dt_session_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`,
          C = (e) => {
            try {
        ...
        let F = async () => {
          ...
          W = async (e = x) => {
            ...
            let t = [
              ...
              { id: Date.now(), text: e, sender: "user", timestamp: O() },
            ];
            h(t), u(""), b(!0);
            let a = await $(e);
            setTimeout(() => {
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
                      ...
                      (0, a.jsxs)("div", {
                        ...
                        children: [
                          a.jsx("button", {
                            ...
                            children: a.jsx(i.Z, { size: 22 }),
                          }),
                          a.jsx("button", {
                            onClick: H,
                            className: "text-white",
                            "aria-label": "Close chat",
                            children: a.jsx(l.Z, { size: 24 }),
                          }),
                        ],
                      }),
                    ],
                    ...
                    children: [
                      s.map((e) =>
                        (0, a.jsxs)(
                          "div",
                          {
                            className: `w-fit max-w-[90%] sm:max-w-[85%] md:max-w-[80%] mb-3 sm:mb-4 ${"user" === e.sender ? "ml-auto" : "mr-auto"}`,
                            children: [
                              a.jsx("div", {
                                className: `p-2 sm:p-3 rounded-lg whitespace-pre-line text-sm sm:text-base break-words ${"user" === e.sender ? "bg-purple-600 text-white rounded-br-none" : "bg-gray-200 text-gray-800 rounded-bl-none"}`,
                                dangerouslySetInnerHTML: {
                                  __html:
                                    "bot" === e.sender ? M(e.text) : e.text,
                                },
                              }),
                              a.jsx("div", {
                                className: `text-xs mt-1 ${"user" === e.sender ? "text-gray-500 text-right" : "text-gray-500 text-left"}`,
                    ...
                    children: (0, a.jsxs)("div", {
                      ...
                      children: [
                        ...
                        a.jsx("button", {
                          onClick: () => W(),
                          disabled: !x.trim() || y,
                          className: `ml-2 p-1 transition-colors ${!x.trim() || y ? "text-gray-300" : "text-purple-600 hover:text-purple-700"}`,
            ...
            !e &&
              a.jsx("button", {
                onClick: H,
                className: `flex items-center justify-center w-16 h-16 sm:w-16 sm:h-16 md:w-16 md:h-16 rounded-full text-white ${g ? "bg-white shadow-lg" : "bg-gray-100 shadow-md"} transition-all duration-300 hover:scale-110 relative`,
    ...
    6462: (e, t, s) => {
      "use strict";
      s.r(t), s.d(t, { default: () => u, metadata: () => x });
      var a = s(9510);
      s(5023);
      var r = s(4052),
        l = s.n(r),
      ...
      let c = (0, n.createProxy)(
        String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/healthcare-chatbot.tsx#default`,
      );
      (0, n.createProxy)(
        String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/Header.tsx#navItems`,
      ),
        (0, n.createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/Header.tsx#loginItems`,
        ),
        (0, n.createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/Header.tsx#Header`,
        );
      let d = (0, n.createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/Header.tsx#default`,
        ),
        m = (0, n.createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/Footer.tsx#default`,
        ),
        h = (0, n.createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/sections/ContactUs.tsx#default`,
        ),
        x = { title: "DataTroops.ai", description: "Created by DataTroops" };
      function u({ children: e }) {
        return (0, a.jsxs)("html", {
          ...
          children: [
            ...
            (0, a.jsxs)("body", {
              className: `${l().variable} ${o().variable} antialiased bg-[var(--color-10002B)] text-gray-300 font-body`,
              children: [
                a.jsx("noscript", {
