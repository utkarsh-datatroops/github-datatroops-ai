  ...
  (exports.modules = {
    ...
    2994: (e, t, r) => {
      ...
      function N(e) {
        let t,
          ...
          [U, D, F] = (0, s.useReducerWithReduxDevtools)(N);
        (0, o.useEffect)(() => {
          j = null;
        }, []);
        let { canonicalUrl: I } = (0, s.useUnwrapState)(U),
          { searchParams: k, pathname: L } = (0, o.useMemo)(() => {
        ...
        if (B.mpaNavigation) {
          if (E.pendingMpaPath !== I) {
            let e = window.location;
            B.pendingPush ? e.assign(I) : e.replace(I), (E.pendingMpaPath = I);
          }
    ...
    6199: (e, t, r) => {
      ...
      function c(e) {
        ...
        let m = new Map();
        (null === f || 0 === f.size) &&
          (0, l.fillLazyItemsTillLeafWithHead)(b, void 0, c, s, h);
        let P = {
          buildId: r,
          tree: c,
          cache: b,
    ...
    5240: (e, t, r) => {
      ...
      let n = r(5424),
        ...
        h = r(5652),
        y = r(4158),
        { createFromFetch: _, encodeReply: g } = r(6493);
