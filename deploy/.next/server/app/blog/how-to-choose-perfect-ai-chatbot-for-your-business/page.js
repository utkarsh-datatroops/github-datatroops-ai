(() => {
  ...
  (e.id = 815),
    ...
    (e.modules = {
        ...
        let d = [
            "",
            {
              children: [
                ...
                {
                  children: [
                    "how-to-choose-perfect-ai-chatbot-for-your-business",
                    {
                      children: [
                        "__PAGE__",
                        {},
                        {
                          page: [
                            () => Promise.resolve().then(o.bind(o, 1768)),
                ...
                },
                {
                  metadata: {
                    icon: [
                      async (e) =>
                        (await Promise.resolve().then(o.bind(o, 3881))).default(
                          e,
                        ),
                    ],
                    apple: [],
            ...
            {
              layout: [
                () => Promise.resolve().then(o.bind(o, 6462)),
                "/Users/dipak/Workspace-DT/datatroops-ai/src/app/layout.tsx",
              ],
              "not-found": [
              ...
              metadata: {
                icon: [
                  async (e) =>
                    (await Promise.resolve().then(o.bind(o, 3881))).default(e),
                ],
                apple: [],
                openGraph: [],
                twitter: [],
          ...
          p = "/blog/how-to-choose-perfect-ai-chatbot-for-your-business/page",
          h = { require: o, loadChunk: () => Promise.resolve() },
          u = new n.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/blog/how-to-choose-perfect-ai-chatbot-for-your-business/page",
              pathname:
                "/blog/how-to-choose-perfect-ai-chatbot-for-your-business",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      7406: (e, t, o) => {
        Promise.resolve().then(o.bind(o, 5326));
      },
      9256: (e, t, o) => {
        "use strict";
        o.d(t, { Z: () => n });
        let n = (0, o(2881).Z)("arrow-up", [
      ...
      5326: (e, t, o) => {
        ...
        var m = o(9256);
        let y = {
          src: "/_next/static/media/How to choose the perfect AI for your business .78d66277.png",
        };
        var x = o(6226),
          b = o(434);
        let g = ({ link: e, title: t, description: o }) =>
            n.jsx("div", {
              className:
                "my-12 p-6 sm:p-10 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg shadow-lg transform transition-all hover:scale-105",
              children: (0, n.jsxs)("div", {
                className:
                  "flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-12",
                children: [
                  (0, n.jsxs)("div", {
                    className: "space-y-4 sm:max-w-xl text-center sm:text-left",
                    children: [
                      n.jsx("h2", {
                        className:
                      ...
                      n.jsx("p", {
                        className: "text-sm sm:text-xl opacity-90",
                        children: o,
                      }),
                    ],
                  }),
                  n.jsx(b.default, {
                    href: e,
                    className:
                      "mt-6 sm:mt-0 bg-blue-800 hover:bg-white text-white hover:text-blue-800 border-2 border-white py-3 px-8 sm:px-12 rounded-full text-lg font-semibold uppercase tracking-wider transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-center",
                    children: "Learn More",
                  }),
                ],
              }),
          ...
          w = ({
            ...
            console.log(v),
              ...
              (0, a.useEffect)(() => {
                let e = () => {
                  P(window.scrollY > 300);
                  let e = document.querySelectorAll("h2[id], h3[id]"),
                    t = "";
                  e.forEach((e) => {
              ...
              switch (e.type) {
                case "h2":
                  return n.jsx(
                    "h2",
                    {
                      id: t,
                      className:
                        "text-3xl font-bold mt-12 mb-6 text-gray-900 scroll-mt-24 border-l-4 border-blue-500 pl-6 bg-gradient-to-r from-blue-50 to-transparent py-4 rounded-r-lg",
                      children: e.content,
                    },
                    e.id,
                  );
                case "h3":
                  return n.jsx(
                    "h3",
                    {
                      id: t,
                      className:
                        "text-2xl font-semibold mt-8 mb-4 text-gray-800 scroll-mt-24",
                      children: e.content,
                    },
                    e.id,
                  );
                case "paragraph":
                  return n.jsx(
                    ...
                    {
                      className:
                        "text-lg text-gray-700 leading-relaxed mb-6 font-light",
                      children: e.content,
                    },
                    e.id,
                  );
                ...
                case "text":
                  return n.jsx(
                    "span",
                    { className: "text-gray-700", children: e.content },
                    e.id,
                  );
                case "link":
                  let o = e.content;
                  return (0, n.jsxs)(
                    b.default,
                    {
                      href: o.url,
                      className:
                        "group inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-all duration-300",
                      rel: "noopener noreferrer",
                      "aria-label": `Go to ${o.text}`,
                      children: [
                        n.jsx("span", { children: o.text }),
                        (0, n.jsxs)("span", {
                          className:
                            "ml-1 inline-block transform transition-all duration-300 opacity-70 group-hover:opacity-100",
                          "aria-hidden": "true",
                          children: ["→", " "],
                        }),
                      ],
                          ...
                          (0, n.jsxs)(
                            "li",
                            {
                              ...
                              children: [
                                n.jsx("span", {
                                  className:
                                    "w-2 h-2 bg-blue-500 rounded-full mt-3 flex-shrink-0",
                                }),
                                n.jsx("span", {
                                  className:
                  ...
                  return n.jsx(
                    "div",
                    {
                      ...
                      children: (0, n.jsxs)("table", {
                        className:
                          "w-full border-collapse border border-gray-300 bg-white rounded-lg shadow-sm",
                        children: [
                          n.jsx("thead", {
                            children: n.jsx("tr", {
                              className: "bg-gray-50",
                              children: a.headers.map((e) =>
                                n.jsx(
                                  "th",
                                  {
                                    className:
                                      "border border-gray-300 px-4 py-3 text-left font-semibold text-gray-900",
                                    children: e.content,
                                  },
                                  e.id,
                                ),
                                ...
                                "tr",
                                {
                                  ...
                                  children: e.map((e) =>
                                    n.jsx(
                                      "td",
                                      {
                                        className: `border border-gray-300 px-4 py-3 ${"bold" === e.type ? "font-semibold text-gray-900" : "text-gray-700"}`,
                                        children: e.content,
                                      },
                                      e.id,
                                    ),
                  ...
                  return (0, n.jsxs)(
                    "figure",
                    {
                      ...
                      children: [
                        n.jsx("div", {
                          className:
                            "relative overflow-hidden rounded-2xl shadow-xl bg-gray-100",
                          children: n.jsx("img", {
                            src: e.src || "/api/placeholder/800/400",
                            alt: e.alt || "",
                            className:
                        ...
                        e.caption &&
                          n.jsx("figcaption", {
                            className:
                              "text-sm text-gray-600 mt-4 text-center italic bg-gray-50 p-3 rounded-lg",
                            children: e.caption,
                          }),
                      ],
                    },
              ...
              children: [
                (0, n.jsxs)("header", {
                  ...
                  children: [
                    (0, n.jsxs)("div", {
                      className:
                        "absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800",
                      children: [
                        n.jsx("div", {
                    ...
                    (0, n.jsxs)("div", {
                      className:
                        "relative mx-auto max-w-6xl px-4 pt-16 pb-20 sm:px-6 lg:px-8",
                      children: [
                        (0, n.jsxs)("div", {
                          className:
                            "mb-8 flex flex-wrap items-center gap-6 text-sm",
                          children: [
                            n.jsx("span", {
                              className:
                                "rounded-full bg-white/20 backdrop-blur-sm px-4 py-2 font-semibold text-white uppercase tracking-wider border border-white/30",
                              children: e,
                            }),
                            (0, n.jsxs)("div", {
                              className:
                              ...
                              children: [
                                (0, n.jsxs)("div", {
                                  ...
                                  children: [
                                    n.jsx(i, { className: "h-4 w-4" }),
                                    n.jsx("span", { children: t }),
                                  ],
                                }),
                                (0, n.jsxs)("div", {
                                  className: "flex items-center gap-2",
                        ...
                        n.jsx("h1", {
                          className:
                            "mb-8 text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl max-w-4xl",
                          children: o,
                        }),
                        (0, n.jsxs)("div", {
                          className:
                            ...
                            (0, n.jsxs)("div", {
                              ...
                              children: [
                                n.jsx("button", {
                                  onClick: () => j && j("twitter"),
                                  className:
                                    "group rounded-full bg-white/20 backdrop-blur-sm p-3 text-white transition-all hover:bg-blue-500 hover:scale-110 border border-white/30",
                                ...
                                n.jsx("button", {
                                  onClick: () => j && j("facebook"),
                                  className:
                                    "group rounded-full bg-white/20 backdrop-blur-sm p-3 text-white transition-all hover:bg-blue-600 hover:scale-110 border border-white/30",
                                ...
                                n.jsx("button", {
                                  onClick: () => j && j("linkedin"),
                                  className:
                                    "group rounded-full bg-white/20 backdrop-blur-sm p-3 text-white transition-all hover:bg-blue-700 hover:scale-110 border border-white/30",
                                ...
                                n.jsx("button", {
                                  ...
                                  className: `group rounded-full p-3 transition-all hover:scale-110 border ${S ? "bg-green-500 text-white border-green-400" : "bg-white/20 backdrop-blur-sm text-white hover:bg-gray-600 border-white/30"}`,
                                  "aria-label": "Copy link",
                                  children: n.jsx(h, { className: "h-5 w-5" }),
                                }),
                                S &&
                                  n.jsx("span", {
                                    className:
                ...
                n.jsx("div", {
                  className:
                    "mx-auto max-w-6xl px-4 -mt-10 relative z-10 sm:px-6 lg:px-8",
                  children: (0, n.jsxs)("div", {
                    className:
                      "relative overflow-hidden rounded-3xl shadow-2xl",
                    children: [
                      n.jsx(x.default, {
                        src: y || "/api/placeholder/1200/600",
                        alt: g,
                        layout: "responsive",
                        width: 1200,
                        height: 600,
                ...
                n.jsx("div", {
                  className:
                    "mx-auto max-w-7xl px-4 mt-16 py-16 sm:px-6 lg:px-8",
                  children: (0, n.jsxs)("div", {
                    ...
                    children: [
                      n.jsx("aside", {
                        ...
                        children: n.jsx("div", {
                          ...
                          children: (0, n.jsxs)("div", {
                            className:
                              "rounded-2xl bg-white shadow-xl border border-gray-100 overflow-hidden",
                            children: [
                              n.jsx("div", {
                                className:
                                  "bg-gradient-to-br from-blue-600 to-purple-600 p-6 text-white",
                                children: (0, n.jsxs)("div", {
                                  className: "flex items-center gap-3 mb-4",
                                  children: [
                                    n.jsx(u, { className: "h-5 w-5" }),
                                    n.jsx("h2", {
                                  ...
                                  children: w.map((e) =>
                                    n.jsx(
                                      "li",
                                      {
                                        children: n.jsx("a", {
                                          href: `#${e.id}`,
                                          className: `block text-sm transition-all duration-200 hover:text-blue-600 hover:translate-x-2 ${1 === e.level ? "font-semibold text-gray-900" : "ml-4 text-gray-600 font-medium"} ${C === e.id ? "text-blue-600 translate-x-2 font-semibold" : ""}`,
                                          children: e.title,
                                        }),
                                      },
                                      e.id,
                      ...
                      (0, n.jsxs)("main", {
                        ...
                        children: [
                          (0, n.jsxs)("div", {
                            className:
                              "mb-12 rounded-2xl bg-white shadow-xl border border-gray-100 overflow-hidden lg:hidden",
                            children: [
                              n.jsx("div", {
                                className:
                                  "bg-gradient-to-br from-blue-600 to-purple-600 p-6 text-white",
                                  ...
                                  children: w.map((e) =>
                                    n.jsx(
                                      "li",
                                      {
                                        children: n.jsx("a", {
                                          href: `#${e.id}`,
                                          className: `block text-sm transition-colors hover:text-blue-600 ${1 === e.level ? "font-semibold text-gray-900" : "ml-4 text-gray-600"}`,
                                          children: e.title,
                                        }),
                                      },
                                      e.id,
                ...
                T &&
                  n.jsx("button", {
                    ...
                    className:
                      "fixed bottom-8 left-8 z-50 rounded-full bg-blue-600 p-4 text-white shadow-2xl transition-all hover:bg-blue-700 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-blue-300",
                    "aria-label": "Scroll to top",
                    children: n.jsx(m.Z, { className: "h-5 w-5" }),
                  }),
              ],
            });
          },
              ...
              content: [
                {
                  ...
                  type: "h2",
                  content:
                    "How To Choose The Perfect AI Chatbot For Your Business",
                },
                {
                  id: 2,
                  type: "paragraph",
                  ...
                  content: [
                    ...
                    [
                      { id: 3, type: "bold", content: "Instant Response Time" },
                      {
                        ...
                        type: "text",
                        content:
                          ": Boost engagement by eliminating wait times.",
                      },
                    ],
                    [
                    ...
                    [
                      { id: 9, type: "bold", content: "Scalability" },
                      {
                        ...
                        type: "text",
                        content:
                          ": Easily handle thousands of interactions at once.",
                      },
                    ],
                  ],
                },
                { id: 6, type: "h2", content: "1. Define Your Use Case" },
                {
                  id: 7,
                  type: "paragraph",
                  content:
                ...
                { id: 8, type: "paragraph", content: "Examples:" },
                {
                  id: 81,
                  type: "unordered-list",
                  content: [
                    ...
                    [
                      { id: 3, type: "text", content: "For SaaS: " },
                      {
                        ...
                        type: "bold",
                        content:
                          "Onboarding, FAQ automation, subscription management.",
                      },
                    ],
                    [
                      {
                        id: 5,
                        type: "text",
                        content: "For service-based businesses: ",
                      },
                      {
                        id: 6,
                        type: "bold",
                ...
                { id: 91, type: "bold", content: "Pro tip" },
                {
                  id: 92,
                  type: "text",
                  content:
                  ...
                  content: [
                    ...
                    [
                      { id: 3, type: "bold", content: "Google Calendar" },
                      {
                        id: 4,
                        type: "text",
                        content: " for appointment scheduling",
                      },
                    ],
                    [
                      {
                        id: 5,
                        type: "bold",
                        content: "Shopify or WooCommerce",
                      },
                      {
                        id: 6,
                        type: "text",
                        content: " (for e-commerce businesses)",
                      },
                    ],
                  ],
                },
                    ...
                    rows: [
                      [
                        ...
                        },
                        {
                          id: 3,
                          type: "text",
                          content: "Simple FAQs, onboarding",
                        },
                      ],
                      [
                  ...
                  content: [
                    [
                      ...
                      { id: 2, type: "bold", content: "restaurant" },
                      {
                        ...
                        type: "text",
                        content:
                          " might only need a rule-based bot for bookings.",
                      },
                    ],
                    [
                ...
                { id: 221, type: "bold", content: "Hybrid chatbots" },
                {
                  id: 222,
                  type: "text",
                    ...
                    [
                      {
                        id: 6,
                        type: "bold",
                        content: "Slack or Microsoft Teams",
                      },
                    ],
                  ],
                },
                ...
                { id: 281, type: "bold", content: "" },
                { id: 282, type: "text", content: " " },
                {
                  id: 29,
                  type: "h2",
                ...
                { id: 32, type: "h2", content: "8. Compare Pricing Models" },
                {
                  id: 33,
                  type: "unordered-list",
                  content: [
                    ...
                    [
                      {
                        id: 4,
                        type: "bold",
                        content: "Enterprise/custom quotes",
                      },
                    ],
                  ],
                },
                    ...
                    [
                      {
                        id: 4,
                        type: "text",
                        content: "Additional charges for ",
                      },
                ...
                { id: 35, type: "h2", content: "9. Read Reviews & Test Demos" },
                {
                  id: 36,
                  type: "unordered-list",
                  content: [
                ...
                { id: 40, type: "h2", content: "Final Thoughts" },
                {
                  id: 41,
                  type: "paragraph",
                  content:
                ...
                { id: 421, type: "text", content: "" },
                { id: 422, type: "text", content: "" },
                {
                  id: 423,
                  type: "link",
                  content: {
                  ...
                  window.open(
                    {
                      ...
                      linkedin:
                        "https://www.linkedin.com/company/datatroops-ai",
                    }[e],
                    "_blank",
                    "noopener,noreferrer",
                  );
      ...
      1768: (e, t, o) => {
        ...
        let n = (0, o(8570).createProxy)(
          String.raw`/Users/dipak/Workspace-DT/datatroops-ai/src/app/blog/how-to-choose-perfect-ai-chatbot-for-your-business/page.tsx#default`,
        );
      },
      3881: (e, t, o) => {
        "use strict";
  ...
  t.C(e);
  var o = (e) => t((t.s = e)),
    n = t.X(0, [948, 103, 621, 261], () => o(7292));
  module.exports = n;
})();
