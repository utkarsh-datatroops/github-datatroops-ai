          ...
          if ((t && "object" == typeof t) || "function" == typeof t)
            for (let n of p(t))
              d.call(e, n) ||
                ...
                s(e, n, {
                  get: () => t[n],
                  enumerable: !(a = o(t, n)) || a.enumerable,
                });
          return e;
        },
        m = (e, t, r) => (c(e, "symbol" != typeof t ? t + "" : t, r), r),
        f = {};
      ((e, t) => {
        for (var r in t) s(e, r, { get: t[r], enumerable: !0 });
      })(f, { default: () => _ }),
        (e.exports = h(s({}, "__esModule", { value: !0 }), f));
      var b =
        ((l = null != (a = r(2265)) ? i(u(a)) : {}),
        h(
          !n && a && a.__esModule
            ? l
            : s(l, "default", { value: a, enumerable: !0 }),
          a,
        ));
      let g = "64px",
        y = {};
      class _ extends b.Component {
        constructor() {
          super(...arguments),
            m(this, "mounted", !1),
            m(this, "state", { image: null }),
        ...
        fetchImage({ url: e, light: t, oEmbedUrl: r }) {
          if (!b.default.isValidElement(t)) {
            if ("string" == typeof t) {
              this.setState({ image: t });
              return;
            }
            if (y[e]) {
              this.setState({ image: y[e] });
              return;
            }
            return (
          ...
          let {
            ...
            o = {
              preview: {
                width: "100%",
                height: "100%",
                backgroundImage: l && !i ? `url(${l})` : void 0,
