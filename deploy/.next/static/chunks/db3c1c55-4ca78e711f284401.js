...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [953],
  {
    41903: function (e, t, n) {
      ...
      var N = o.createContext({ isTransitioning: !1 });
      ...
      var _ = o.createContext({ outlet: null, matches: [], isDataRoute: !1 });
      _.displayName = "Route";
      ...
      function j(e, { relative: t } = {}) {
        let { matches: n } = o.useContext(_),
          { pathname: r } = W(),
          a = JSON.stringify(x(n));
        return o.useMemo(
          () => E(e, JSON.parse(a), r, "path" === t),
          [e, a, r, t],
        );
      }
          ...
          return (
            ...
            (h = o.createElement(
              ...
              o.createElement(
                ...
                o.createElement("code", { style: c }, "ErrorBoundary"),
                " or",
                " ",
                o.createElement("code", { style: c }, "errorElement"),
                " prop on your route.",
              ),
            )),
            o.createElement(
              ...
              o.createElement("h3", { style: { fontStyle: "italic" } }, i),
              l
                ? o.createElement(
                    "pre",
                    { style: { padding: "0.5rem", backgroundColor: s } },
                    l,
                  )
                : null,
              h,
      ...
      function D({ routeContext: e, match: t, children: n }) {
        ...
        return (
          ...
          o.createElement(_.Provider, { value: e }, n)
        );
      }
      function B(e) {
      ...
      function Y({
        ...
        let l = e.replace(/^\/*/, "/"),
          c = o.useMemo(
            () => ({ basename: l, navigator: a, static: i, future: {} }),
            [l, a, i],
          );
        ...
        return (s(
          null != y,
          `<Router basename="${l}"> is not able to match the URL "${h}${d}${m}" because it does not start with the basename, so the <Router> won't render anything.`,
        ),
        null == y)
          ? null
          : o.createElement(
              P.Provider,
              { value: c },
              o.createElement(O.Provider, { children: t, value: y }),
            );
      }
      o.memo(function ({ routes: e, future: t, state: n }) {
        return (function (e, t, n, r) {
          let a;
          u(
            M(),
          ...
          let { navigator: i } = o.useContext(P),
            { matches: l } = o.useContext(_),
            c = l[l.length - 1],
            h = c ? c.params : {},
            d = c ? c.pathname : "/",
            m = c ? c.pathnameBase : "/",
...
Please change the parent <Route path="${e}"> to <Route path="${"/" === e ? "*" : `${e}/*`}">.`,
          ...
          let x = (function (e, t = [], n = null, r = null) {
            ...
            return a.reduceRight((e, r, u) => {
              ...
              return n &&
                (r.route.ErrorBoundary || r.route.errorElement || 0 === u)
                ? o.createElement(U, {
                    location: n.location,
      ...
      async function en(e, t, n) {
        ...
        return (
          ...
          r.reduce((e, t) => {
            ...
            return o.has(n) || (o.add(n), e.push({ key: n, link: t })), e;
          }, [])
        );
      }
      ...
      function ea(e, t, { includeHydrateFallback: n } = {}) {
        return [
          ...new Set(
            e
              .map((e) => {
      ...
      function eh({ page: e, ...t }) {
        let { router: n } = ei(),
          r = o.useMemo(
            () => f(n.routes, e, n.basename),
            [n.routes, e, n.basename],
          );
        return r ? o.createElement(ed, { page: e, matches: r, ...t }) : null;
      }
      function ed({ page: e, matches: t, ...n }) {
        let r = W(),
          { manifest: a, routeModules: i } = es(),
          { basename: l } = ei(),
          { loaderData: u, matches: s } = el(),
          ...
          d = o.useMemo(() => {
            ...
            let h =
              ...
              (n =
                ...
                : l && "/" === w(n.pathname, l)
                  ? (n.pathname = `${l.replace(/\/$/, "")}/_root.data`)
          ...
          m = (function (e) {
            let { manifest: t, routeModules: n } = es(),
              [r, a] = o.useState([]);
            return (
              o.useEffect(() => {
                let r = !1;
      ...
      function em(e) {
        let {
          ...
          { router: u, static: s, staticContext: c } = ei(),
          { matches: h } = el(),
          d = "lazy" === i.mode && !0 === l;
...
${p
  .map((e, n) => {
    ...
    Z(a, `Route ${e.route.id} not found in manifest`);
    let {
      ...
      c = [
        ...(o ? [{ module: o, varName: `${r}_clientAction` }] : []),
        ...(i ? [{ module: i, varName: `${r}_clientLoader` }] : []),
        ...(l ? [{ module: l, varName: `${r}_clientMiddleware` }] : []),
        ...(u ? [{ module: u, varName: `${r}_HydrateFallback` }] : []),
        { module: s, varName: `${r}_main` },
      ];
    return 1 === c.length
      ? `import * as ${r} from ${JSON.stringify(s)};`
      : [
          c
            .map((e) => `import * as ${e.varName} from "${e.module}";`)
            .join("\n"),
      ...
      ? `window.__reactRouterManifest = ${JSON.stringify(
          (function ({ sri: e, ...t }, n) {
            let r = new Set(n.state.matches.map((e) => e.route.id)),
              a = n.state.location.pathname.split("/").filter(Boolean),
              o = ["/"];
            ...
            return { ...t, routes: i, sri: !!e || void 0 };
          })(t, u),
          null,
          2,
        )};`
...
import(${JSON.stringify(t.entry.module)});`
            ...
            : [
                ...new Set(
                  t.entry.imports.concat(
                    ea(p, t, { includeHydrateFallback: !0 }),
                  ),
                ),
              ],
      ...
      function eg({ basename: e, children: t, window: n }) {
        let r = o.useRef();
        null == r.current &&
          (r.current = (function (e = {}) {
            return (function (e, t, n, r = {}) {
              ...
              function f() {
                ...
                let e = p(),
                  t = null == e ? null : e - d;
                (d = e), s && s({ action: u, location: g.location, delta: t });
              }
              null == d &&
                ((d = 0), i.replaceState({ ...i.state, idx: d }, ""));
              let g = {
                get action() {
                  return u;
                },
        ...
        let a = r.current,
          [i, u] = o.useState({ action: a.action, location: a.location }),
          s = o.useCallback(
            (e) => {
        ...
        return (
          o.useLayoutEffect(() => a.listen(s), [a, s]),
          o.createElement(Y, {
            basename: e,
            children: t,
            location: i.location,
      ...
      var ey = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
        ev = o.forwardRef(function (
          ...
          let y,
            { basename: v } = o.useContext(P),
            b = "string" == typeof h && ey.test(h),
            C = !1;
          if ("string" == typeof h && b && ((y = h), ef))
            try {
          ...
          let R = (function (e, { relative: t } = {}) {
              u(
                M(),
                "useHref() may be used only in the context of a <Router> component.",
              );
              let { basename: n, navigator: r } = o.useContext(P),
                { hash: a, pathname: i, search: l } = j(e, { relative: t }),
                s = i;
              return (
                "/" !== n && (s = "/" === i ? n : $([n, i])),
                r.createHref({ pathname: s, search: l, hash: a })
              );
            })(h, { relative: r }),
            [S, k, N] = (function (e, t) {
            ...
            O = (function (
              ...
              let c = (function () {
                  let { isDataRoute: e } = o.useContext(_);
                  return e
                    ? (function () {
                        var e;
                        let t;
                    ...
                    : (function () {
                        ...
                        let e = o.useContext(L),
                          { basename: t, navigator: n } = o.useContext(P),
                          { matches: r } = o.useContext(_),
                          { pathname: a } = W(),
      ...
      function ew(e) {
        ...
        return (
          u(
            t,
            `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`,
          ),
          t
        );
      }
      (ev.displayName = "Link"),
        (o.forwardRef(function (
          ...
          let d,
            p = j(i, { relative: c.relative }),
            m = W(),
            f = o.useContext(k),
            { navigator: g, basename: y } = o.useContext(P),
            b =
              null != f &&
              (function (e, t = {}) {
                ...
                let { basename: r } = ew("useViewTransitionState"),
          ...
          let C = "/" !== x && x.endsWith("/") ? x.length - 1 : x.length,
            ...
            S =
              null != $ &&
              ($ === x ||
                (!r && $.startsWith(x) && "/" === $.charAt(x.length))),
            L = { isActive: R, isPending: S, isTransitioning: b },
            O = R ? e : void 0;
          d =
            "function" == typeof n
              ? n(L)
        ...
        (o.forwardRef(
          (
            ...
            let y = (function () {
                let { router: e } = ew("useSubmit"),
                  { basename: t } = o.useContext(P),
                  n = I("useRouteId");
                return o.useCallback(
                  async (r, a = {}) => {
                    let {
                      ...
                      if (q(e) && "form" === e.tagName.toLowerCase()) {
                        ...
                        (r = i ? w(i, t) : null),
                          ...
                          (a = Q(e.getAttribute("enctype")) || V),
                          (o = new FormData(e));
                      } else if (
                        (q(e) && "button" === e.tagName.toLowerCase()) ||
                        (q(e) &&
                        ...
                        if (
                          ...
                          (n =
                            ...
                            K),
                          (a =
                            Q(e.getAttribute("formenctype")) ||
                            Q(i.getAttribute("enctype")) ||
                            V),
                          (o = new FormData(i, e)),
                          !(function () {
                            if (null === X)
