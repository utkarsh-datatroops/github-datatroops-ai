(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [746],
  {
    29983: function (e, t, n) {
      Promise.resolve().then(n.bind(n, 54905));
    },
    ...
    54905: function (e, t, n) {
      ...
      var i = n(2265);
      let s = (0, n(78030).Z)("chevron-down", [
        ...
        d = [
          {
            id: "contact",
            name: "Contact & Sales",
            items: c.filter((e) => "contact" === e.category),
          },
          {
            id: "services",
            name: "Our Services",
            items: c.filter((e) => "services" === e.category),
          },
          {
            id: "process",
            name: "Project Process",
            items: c.filter((e) => "process" === e.category),
          },
          {
            id: "support",
            name: "Support & Maintenance",
            items: c.filter((e) => "support" === e.category),
          },
          {
            id: "security",
            name: "Data Security",
            items: c.filter((e) => "security" === e.category),
          },
        ],
        u = (e) => {
          let { item: t, isOpen: n, onToggle: r } = e,
            a = (0, i.useRef)(null),
            [l, c] = (0, i.useState)(void 0);
          return (
            (0, i.useEffect)(() => {
              a.current && c(a.current.scrollHeight);
            }, [t.answer]),
            (0, o.jsxs)("div", {
              className: "faq-item",
              ...
              children: [
                (0, o.jsxs)("button", {
                  ...
                  children: [
                    (0, o.jsx)("span", { children: t.question }),
                    (0, o.jsx)(s, {
                      className: "chevron ".concat(n ? "open" : ""),
                      style: {
                        height: "1.25rem",
                        width: "1.25rem",
      ...
      var p = (e) => {
          let {
              ...
              description:
                n = "Find answers to common questions about our products and services.",
              categories: r = d,
              items: a = c,
              className: s = "",
            } = e,
            ...
            children: [
              ...
              (0, o.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, o.jsx)(m, { searchTerm: h, onSearchChange: f }),
                  "" === h.trim() &&
                    (0, o.jsxs)("div", {
                      style: {
                        display: "flex",
        ...
        f = n(30568);
      let x = [
        { name: "Twitter", icon: f.mdU, href: "https://x.com/Datatroops_ai" },
        {
          name: "LinkedIn",
          icon: f.D9H,
              ...
              children: x.map((e) => {
                ...
                return (0, o.jsx)(
                  "a",
                  {
                    ...
                    "aria-label": t,
                    children: (0, o.jsx)(h.G, { icon: n, size: "lg" }),
                  },
                  t,
                );
              }),
            ...
            try {
              (
                await fetch("https://formsubmit.co/ajax/info@datatroops.io", {
                  ...
                  body: JSON.stringify({ name: n, email: i, message: l }),
                })
              ).ok
                ? (u(!0),
                  a(""),
              ...
              p("Failed to send message. Please try later. ".concat(e));
            }
          };
        return (0, o.jsx)("section", {
          className:
