(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    8957: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 83146));
    },
    83146: function (e, t, r) {
      "use strict";
      r.r(t),
        r.d(t, {
          default: function () {
      ...
      var a = r(57437),
        ...
        o = (e) => {
          ...
          return (0, a.jsx)(i.E.div, {
            className: (0, l.cn)("w-full h-full", r),
            initial: { opacity: 0, y: n ? -20 : 20 },
            whileInView: { opacity: 1, y: 0 },
            viewport: { once: !1 },
            transition: {
              delay: s,
              duration: o ? 0.2 : 0.4,
              type: o ? "keyframes" : "spring",
              stiffness: o && 100,
            },
            children: t,
          });
        ...
        m = r(87138);
      let u = (e) => {
        let { word: t, className: r, variant: s, duration: n = 1 } = e;
        return (0, a.jsx)(i.E.h1, {
          initial: "hidden",
          animate: "visible",
            ...
            (0, a.jsx)(d, {
              className: (function () {
                for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
                  t[r] = arguments[r];
                return (0, p.m6)((0, g.W)(t));
              })(f({ variant: n, size: i, className: l })),
              ref: t,
              ...c,
            })
          );
      ...
      let j = (e) => {
          ...
          (0, s.useEffect)(
            () => (
              u.current && (h.current = u.current.getContext("2d")),
              j(),
              L(),
          ...
          let j = () => {
            ...
            w = () => {
              x.current &&
                ...
                h.current &&
                ((p.current.length = 0),
                (v.current.w = x.current.offsetWidth),
                (v.current.h = x.current.offsetHeight),
                (u.current.width = v.current.w * C),
                (u.current.height = v.current.h * C),
            ...
            H = function (e) {
              ...
              if (h.current) {
                ...
                h.current.translate(s, l),
                  h.current.beginPath(),
                  h.current.arc(r, a, n, 0, 2 * Math.PI),
                  (h.current.fillStyle = "rgba("
                    .concat(N.join(", "), ", ")
                    .concat(i, ")")),
                  h.current.fill(),
                  h.current.setTransform(C, 0, 0, C, 0, 0),
                  t || p.current.push(e);
              }
            },
            M = () => {
              h.current && h.current.clearRect(0, 0, v.current.w, v.current.h);
            },
            Z = () => {
              M();
          ...
          return (0, a.jsx)("div", {
            ...
            ref: x,
            "aria-hidden": "true",
            children: (0, a.jsx)("canvas", { ref: u, className: "size-full" }),
          });
        },
            ...
            children: [
              (0, a.jsx)(o, {
                children: (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)(U, { title: "Generative AI tools" }),
                    (0, a.jsx)("h2", {
                      className:
      ...
      let K = [
        ...
        J = (e) => {
          let { title: t, description: r, icon: s, index: n } = e;
          return (0, a.jsxs)("div", {
            className: (0, l.cn)(
      ...
      er.displayName = ee.aV.displayName;
      let ea = s.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(ee.xz, {
          ref: t,
          className: (0, l.cn)(
      ...
      ea.displayName = ee.xz.displayName;
      let es = s.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(ee.VY, {
          ref: t,
          className: (0, l.cn)(
      ...
      es.displayName = ee.VY.displayName;
      var el = r(34446),
        en = r(22468),
        ei = r(45282),
        eo = r(26391),
        ec = r(55382);
      function ed(e) {
        let { value: t, direction: r = "up", delay: n = 0, className: i } = e,
          o = (0, s.useRef)(null),
          c = (0, ei.c)("down" === r ? t : 0),
          d = (0, eo.q)(c, { bounce: 0.15 }),
          m = (0, ec.Y)(o, { once: !0, margin: "0px" });
        return (
          (0, s.useEffect)(() => {
            m &&
              setTimeout(() => {
          ...
          children: [
            (0, a.jsx)(o, {
              children: (0, a.jsxs)("div", {
                ...
                children: [
                  (0, a.jsx)(U, { title: "Choose your plan" }),
                  (0, a.jsx)("h2", {
                    className:
                      "text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6",
      ...
      let eh = [
        ...
        ep = eh.slice(0, eh.length / 2),
        eg = eh.slice(eh.length / 2),
        ef = (e) => {
      ...
      (eV.displayName = "Card"),
        (s.forwardRef((e, t) => {
          ...
          return (0, a.jsx)("div", {
            ref: t,
            className: eZ("flex flex-col space-y-1.5 p-6", r),
            ...s,
          });
        ...
        (s.forwardRef((e, t) => {
          ...
          return (0, a.jsx)("p", {
            ref: t,
            className: eZ("text-sm text-muted-foreground", r),
            ...s,
          });
        }).displayName = "CardDescription");
      let eL = s.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)("div", {
          ref: t,
          className: eZ("p-6 pt-0", r),
          ...s,
        });
      });
      (eL.displayName = "CardContent"),
        (s.forwardRef((e, t) => {
          let { className: r, ...s } = e;
          return (0, a.jsx)("div", {
            ref: t,
            className: eZ("flex items-center p-6 pt-0", r),
            ...s,
          });
      ...
      var eI = r(6864),
        ...
        eE = r(68132),
        eS = r(16292);
      let e_ = s.forwardRef((e, t) => {
        let { className: r, children: s, ...n } = e;
        return (0, a.jsxs)(eS.fC, {
          ref: t,
          className: (0, l.cn)("relative overflow-hidden", r),
          ...n,
          children: [
            (0, a.jsx)(eS.l_, {
      ...
      e_.displayName = eS.fC.displayName;
      let eR = s.forwardRef((e, t) => {
        let { className: r, orientation: s = "vertical", ...n } = e;
        return (0, a.jsx)(eS.gb, {
          ref: t,
          orientation: s,
          className: (0, l.cn)(
          ...
          ...n,
          children: (0, a.jsx)(eS.q4, {
            className: "relative flex-1 rounded-full bg-border",
          }),
        });
      });
      eR.displayName = eS.gb.displayName;
      var eT = r(75824),
        eP = () => {
          let e = [...ez.n]
            .sort(
          ...
          return (0, a.jsx)("section", {
            ...
            children: (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  className:
                    "flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12",
                  children: [
                    (0, a.jsxs)("div", {
                      children: [
                        (0, a.jsxs)("div", {
                    ...
                    (0, a.jsxs)(eE.z, {
                      variant: "outline",
                      className:
                        "group border-white text-white hover:text-white ",
                      children: [
                        "View All Posts",
                        (0, a.jsx)(d.Z, {
                          className:
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)(e_, {
                      ...
                      children: (0, a.jsx)("div", {
                        className:
                          "flex gap-6 pb-4 md:hidden overflow-x-auto snap-x snap-mandatory pl-1",
                        children: e.map((e) =>
                          (0, a.jsx)(
                            "div",
                            {
                    ...
                    (0, a.jsx)("div", {
                      className:
                        "hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6",
                      children: e.map((e) =>
                        (0, a.jsx)(
                          eT.Z,
                          {
                          ...
                          (0, a.jsx)(
                            "div",
                            {
                              className: "h-1.5 rounded-full ".concat(
                                0 === e ? "w-6 bg-gray-800" : "w-2 bg-gray-300",
                              ),
                            },
                            e,
                          ),
    ...
    75824: function (e, t, r) {
      ...
      var a = r(57437),
        ...
        n = r(71976);
      t.Z = (e) => {
        let { title: t, excerpt: r, imageUrl: i, category: o } = e;
        return (0, a.jsx)(s.Zb, {
          className:
            "overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full",
          children: (0, a.jsxs)("div", {
            className: "grid grid-rows-[200px,1fr]",
            children: [
              (0, a.jsx)("div", {
                ...
                children: (0, a.jsx)("div", {
                  ...
                  children: (0, a.jsx)("span", {
                    className:
                      "px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium text-white inline-block",
                    children: o,
                  }),
                }),
              }),
  ...
  function (e) {
    e.O(0, [138, 648, 950, 164, 751, 693, 609, 971, 23, 744], function () {
      return e((e.s = 8957));
    }),
      (_N_E = e.O());
  },
