(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [753],
  {
    10320: function (e, t, i) {
      Promise.resolve().then(i.bind(i, 66574));
    },
    66574: function (e, t, i) {
      "use strict";
      i.r(t),
        i.d(t, {
          default: function () {
                          ...
                          (0, s.jsx)(
                            r.E.div,
                            {
                              ...
                              children:
                                2 === e.id || 4 === e.id
                                  ? (0, s.jsxs)(h.default, {
                                      href: "".concat(e.href || "default-link"),
      ...
      var f = (e) => {
        ...
        let {
            data: m = A,
            sectionTitle: h = "Real-World Results",
            sectionDescription:
              x = "Discover how leading organizations transformed their operations with our AI solutions, achieving measurable impact and sustainable growth.",
          } = e,
          [p, f] = (0, n.useState)(0);
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("p", {
                                ...
                                children: b.challenge,
                              }),
                            ],
                          }),
                        (b.solution || (b.details && b.details.length > 0)) &&
                          (0, s.jsxs)("div", {
                            className:
                              "bg-white/5 rounded-xl p-6 border border-white/10",
                            children: [
      ...
      function E() {
        ...
        let { scrollYProgress: A } = (0, u.v)({
          target: e,
          offset: ["start start", "end end"],
        });
        A.onChange((e) => {
          a(e),
            c(Math.max(0, Math.min(Math.floor(e * N.length), N.length - 1)));
        });
        let f = (t) => {
            if (e.current) {
        ...
        return (0, s.jsxs)("section", {
          ...
          children: [
            ...
            (0, s.jsx)("div", {
              ...
              children: (0, s.jsx)("div", {
                className:
                  "sticky top-0 h-screen flex items-center py-8 md:py-16 px-4 sm:px-6 md:px-8",
                children: (0, s.jsxs)("div", {
                  className:
                    "max-w-7xl mx-auto w-full grid md:grid-cols-3 gap-8 md:gap-12 items-start",
                  children: [
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        (0, s.jsxs)(r.E.div, {
                          ...
                          children: [
                            (0, s.jsx)("h2", {
                              className:
                                "text-4xl md:text-4xl md:text-5xl font-light mb-3 text-white leading-tight",
                              children: "Seamless AI Integration",
                            }),
                            (0, s.jsx)("p", {
                              className:
                                "text-base md:text-lg text-gray-300 max-w-2xl md:mx-0 mx-auto",
                              children:
                        ...
                        (0, s.jsxs)(
                          r.E.div,
                          {
                            ...
                            children: [
                              (0, s.jsxs)("div", {
                                className:
                                  "flex items-center gap-3 md:gap-6 flex-wrap justify-center md:justify-start",
                                children: [
                                  (0, s.jsx)("div", {
                                    className:
                                  ...
                                  (0, s.jsxs)("div", {
                                    className:
                                      "flex-1 min-w-[180px] text-center md:text-left",
                                    children: [
                                      (0, s.jsxs)("div", {
                                        className:
                                        ...
                                        children: [
                                          ...
                                          (0, s.jsx)("h3", {
                                            className:
                                              "text-2xl md:text-3xl text-left font-light text-white",
                                            children: (0, s.jsx)("span", {
                                              className: "",
                                              children: N[o].title,
                                            }),
                              ...
                              (0, s.jsx)("p", {
                                className:
                                  "text-base md:text-lg text-gray-300 leading-relaxed text-center md:text-left",
                                ...
                                r.E.div,
                                {
                                  ...
                                  children: [
                                    ...
                                    (0, s.jsx)("div", {
                                      ...
                                      children: N[o].keyFeatures.map((e, t) =>
                                        (0, s.jsxs)(
                                          r.E.div,
                                          {
                              ...
                              o === N.length - 1 &&
                                (0, s.jsx)(r.E.div, {
                                  ...
                                  className:
                                    "pt-3 md:pt-4 text-center md:text-left",
                                  children: (0, s.jsxs)("button", {
                                    onClick: () => m(!0),
                                    className:
                                      "inline-flex bg-white text-[#10002B] hover:bg-gray-100 px-5 py-2 md:px-6 md:py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto md:mx-0",
                                    children: [
                                      (0, s.jsx)("span", {
                    ...
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        (0, s.jsx)("h3", {
                          className:
                            "text-lg md:text-xl font-semibold mb-4 md:mb-6 text-white text-center md:text-left",
            ...
            d &&
              (0, s.jsx)("div", {
                ...
                children: (0, s.jsxs)(r.E.div, {
                  ...
                  className:
                    "bg-gradient-to-br from-[#10002B] to-[#240046] rounded-xl shadow-2xl w-full max-w-2xl relative",
                  children: [
                    (0, s.jsx)("button", {
                      onClick: () => {
                        m(!1);
                      ...
                      children: (0, s.jsx)(l.aHS, { className: "w-6 h-6" }),
                    }),
                    (0, s.jsxs)("div", {
                      className: "p-6",
                      children: [
                    ...
                    h &&
                      (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsx)("div", {
                          className:
                            "bg-[#7B2CBF] text-white px-8 py-4 rounded-lg shadow-lg text-xl font-semibold animate-fade-in-out",
            ...
            try {
              (
                await fetch("https://formsubmit.co/ajax/info@datatroops.io", {
                  ...
                  body: JSON.stringify({ name: i, email: r, message: l }),
                })
              ).ok
                ? (u(!0),
                  n(""),
              ...
              h("Failed to send message. Please try later. ".concat(e));
            }
          };
        return (0, s.jsx)("section", {
          className:
              ...
              (0, s.jsxs)("form", {
                ...
                children: [
                  ...
                  (0, s.jsx)("button", {
                    ...
                    children: d ? "Message Sent!" : "Send Message",
                  }),
                  m &&
                    (0, s.jsx)("p", {
    ...
    91810: function (e, t, i) {
      ...
      var s = i(2265),
        ...
        n = s.createContext && s.createContext(a),
        r = ["attr", "size", "title"];
      function o() {
          ...
          s.createElement(
            ...
            (function e(t) {
              return (
                t &&
                t.map((t, i) =>
                  s.createElement(t.tag, c({ key: i }, t.attr), e(t.child)),
                )
              );
            })(e.child),
          );
      ...
      function u(e) {
        ...
        return void 0 !== n
          ? s.createElement(n.Consumer, null, (e) => t(e))
          : t(a);
      }
    },
  },
  function (e) {
    e.O(0, [699, 648, 138, 950, 164, 59, 987, 849, 971, 23, 744], function () {
      return e((e.s = 10320));
    }),
      (_N_E = e.O());
  },
