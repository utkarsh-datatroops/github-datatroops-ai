(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [753],
  {
    ...
    95991: function (e, t, i) {
      ...
      function N() {
        ...
        let { scrollYProgress: A } = (0, m.v)({
          target: e,
          offset: ["start start", "end end"],
        });
        A.onChange((e) => {
          a(e),
            c(Math.max(0, Math.min(Math.floor(e * j.length), j.length - 1)));
        });
        let f = (t) => {
            if (e.current) {
                                ...
                                r.E.div,
                                {
                                  ...
                                  children: [
                                    ...
                                    (0, s.jsx)("div", {
                                      ...
                                      children: j[o].keyFeatures.map((e, t) =>
                                        (0, s.jsxs)(
                                          r.E.div,
                                          {
        ...
        let { onSuccess: t } = e,
          ...
          p = async (e) => {
            ...
            try {
              ...
              x("Failed to send message. Please try later. ".concat(e));
            }
          };
        return (0, s.jsx)("section", {
          className:
  ...
  function (e) {
    e.O(0, [699, 648, 950, 164, 504, 987, 849, 971, 23, 744], function () {
      return e((e.s = 38958));
    }),
      (_N_E = e.O());
  },
