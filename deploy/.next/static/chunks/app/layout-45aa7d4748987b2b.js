(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [185],
  {
    ...
    61485: function (e, t, s) {
      ...
      let d = [
          ...
          { name: "Blogs", href: "/datatroops-blogs" },
        ],
        m = [
          {
            ...
            (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)("header", {
                ...
                children: (0, a.jsx)("div", {
                  className: "container",
                  children: (0, a.jsxs)("div", {
                    className: "h-18 lg:h-20 flex justify-between items-center",
                    children: [
                      (0, a.jsxs)("div", {
                      ...
                      (0, a.jsx)("div", {
                        ...
                        children: (0, a.jsxs)("button", {
                          onClick: () => t((e) => !e),
                          className:
                            "size-10 rounded-lg border-2 relative flex flex-col justify-center items-center gap-1 hover:border-white transition-colors duration-200 hover:scale-105 transform",
                          children: [
                            (0, a.jsx)("div", {
                              className:
              ...
              children: [
                (0, a.jsx)("div", {
                  className: (0, l.m6)(
                    ...
                    e ? "scale-100 opacity-100" : "scale-75 opacity-0",
                  ),
                  children: (0, a.jsx)(i, {}),
                }),
                (0, a.jsx)("div", {
                ...
                (0, a.jsx)("div", {
                  ...
                  children: (0, a.jsxs)("nav", {
                    ...
                    children: [
                      ...
                      m.map((t, s) => {
                        let { buttonVariant: r, name: i, href: c } = t;
                        return (0, a.jsx)(
                          o.default,
                          {
                            href: c,
      ...
      var d = s(53833),
        ...
        u = () => {
          let [e, t] = (0, r.useState)(!1),
            ...
            O = () => {
              let e = I();
              if (e) k(e.sessionId), l(e.messages), v(e.chatState);
              else {
                let e = D();
                k(e),
                  F({
          ...
          let M = async () => {
            ...
            U = async function () {
              ...
              let t = [
                ...
                { id: Date.now(), text: e, sender: "user", timestamp: P() },
              ];
              l(t), x(""), b(!0);
              let a = await Z(e);
              setTimeout(() => {
  ...
  function (e) {
    e.O(
      0,
      [141, 681, 2, 676, 958, 138, 648, 164, 920, 971, 23, 744],
      function () {
        return e((e.s = 60574));
      },
    ),
