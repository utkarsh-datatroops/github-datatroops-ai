(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [931],
  {
    ...
    68765: function (e, t, a) {
      Promise.resolve().then(a.bind(a, 97557));
    },
    97557: function (e, t, a) {
      "use strict";
      a.r(t),
        a.d(t, {
          default: function () {
      ...
      let d = (e) =>
        ...
        A = () => {
          let e = (0, o.useRef)(null),
            [t, a] = (0, o.useState)(!1),
            [i, r] = (0, o.useState)(0),
            [c, A] = (0, o.useState)({ x: 0, y: 0 }),
            [m, u] = (0, o.useState)(""),
            [h, x] = (0, o.useState)(""),
            [g, p] = (0, o.useState)(!1),
            f = (e) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.toLowerCase());
          (0, o.useEffect)(() => {
            ...
            let s = () => {
                ...
                let t = e.current.getBoundingClientRect(),
                  ...
                  s = -t.height;
                r(Math.max(0, Math.min(1, (a - t.top) / (a - s))));
              },
              i = (t) => {
                if (!e.current) return;
            ...
            return (
              ...
              window.addEventListener("mousemove", i, { passive: !0 }),
              () => {
                clearTimeout(n),
                  t.disconnect(),
                ...
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    [void 0, void 0, void 0, void 0, void 0].map((e, t) => {
                      let a = 150 + 40 * t,
                        r = 100 + 30 * t,
                        o = y(50, 50, a / 10, a / 20, (Math.PI / 2.5) * t);
                      return (0, s.jsx)(
                        "div",
                        {
                          style: {
                  ...
                  children: [
                    (0, s.jsx)("div", {
                      style: {
                        opacity: 0.7 + 0.3 * i,
                        transform: "rotate("
                          .concat(-15 * i, "deg) scale(")
                          .concat(1 + 0.2 * i, ")"),
                        filter: "hue-rotate(".concat(30 * i, "deg)"),
                      },
                      className:
                        n().dynamic([
                          ["a4b6d2ff32ac776a", [100 * Math.random() - 50]],
                      ...
                      children: [
                        ...
                        (0, s.jsxs)("form", {
                          style: {
                            ...
                            boxShadow: "0 4px "
                              .concat(12 + 15 * i, "px rgba(139, 92, 246, ")
                              .concat(0.1 + 0.3 * i, ")"),
                            background:
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                ...
                (0, s.jsx)("h2", {
                  ...
                  children: l
                    ? (0, s.jsx)(g.default, { href: l, children: t })
                    : (0, s.jsx)(
                        v.Z,
              ...
              (0, s.jsx)("div", {
                ...
                children: a
                  ...
                  : (0, s.jsx)("div", {
                      ...
                      children: n.map((e) => (0, s.jsx)(j, { ...e }, e.title)),
                    }),
              }),
            ],
          })
      ...
      var E = (e) => {
        ...
        M = () => {
              ...
              let e = async () => {
                ...
                for (; e < S.length; ) {
                  ...
                  "bot" === t.type &&
                    ...
                    i(!1)),
                    W({ type: t.type, text: t.text, time: L() }),
          ...
          let D = (e) =>
            ...
            R = (e) => {
              N((t) => ({ ...t, email: e })),
                G(e) ? C("") : C("Please enter a valid email address.");
            },
            H = (e) => {
              N((t) => ({ ...t, phone: e })),
      ...
      var S = () => {
        let [e, t] = (0, o.useState)(0),
          a = W[e],
          i = () => {
            t((e) => (0 === e ? W.length - 1 : e - 1));
          },
          r = () => {
            t((e) => (e === W.length - 1 ? 0 : e + 1));
          };
        return (0, s.jsx)("section", {
      ...
      let V = o.forwardRef((e, t) => {
        let { src: a, className: i, ...r } = e;
        return (0, s.jsx)(Z.Ee, {
          ref: t,
          src: a || "/images/default-avatar.jpg",
          className: O("h-full w-full object-cover", i),
          ...r,
        });
      });
      V.displayName = Z.Ee.displayName;
      ...
      q.displayName = Z.NY.displayName;
                ...
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        (0, s.jsx)(J, { text: "99.9% Uptime" }),
                        (0, s.jsx)(J, { text: "End-to-end encryption" }),
                        (0, s.jsx)(J, { text: "24/7 Support" }),
                        (0, s.jsx)(J, { text: "Cost Effective" }),
                      ],
                    }),
                  ],
                }),
            ...
            children: [
              ...
              e &&
                (0, s.jsx)("button", {
                  ...
                  children: (0, s.jsx)(et.Z, { className: "h-5 w-5" }),
                }),
            ],
          })
        );
                    ...
                    children: [
                      ...
                      (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsxs)("a", {
                          ...
                          children: [
                            "Get Started",
                            (0, s.jsx)(r.G, { icon: n.eFW, className: "ml-3" }),
                          ],
                        }),
                      }),
                    ],
