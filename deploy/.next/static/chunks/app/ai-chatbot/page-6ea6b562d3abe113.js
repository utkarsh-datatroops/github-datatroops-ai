(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    52637: function (e, t, s) {
      ...
      var a = s(57437),
        ...
        I = () => {
          ...
          let [g, f] = (0, r.useState)(""),
            [b, y] = (0, r.useState)(!1),
            [j, w] = (0, r.useState)({ email: "", phone: "", query: "" }),
            v = (0, r.useCallback)(
            ...
            Z = (0, r.useCallback)(async () => {
              M.current += 1;
              let e = M.current;
              for (let s of (t([]), h(!0), n(!1), D)) {
                if (M.current !== e) break;
                if ("bot" === s.type) {
                  if (
                    (n(!0),
          ...
          let F = (0, r.useCallback)(
            ...
            H = (0, r.useCallback)((e) => w((t) => ({ ...t, email: e })), []),
            L = (0, r.useCallback)((e) => w((t) => ({ ...t, phone: e })), []),
            G = (0, r.useCallback)(() => {
              !g.trim() ||
                x ||
                s ||
        ...
        P = () => {
          let [e, t] = (0, r.useState)(0),
            s = [
              {
                icon: (0, a.jsx)(n.Z, { className: "w-6 h-6 md:w-8 md:h-8" }),
                name: "Healthcare",
                description:
              ...
              {
                icon: (0, a.jsx)(o.Z, { className: "w-6 h-6 md:w-8 md:h-8" }),
                name: "Real Estate",
                description:
          ...
          let S = [
              {
                name: "E-commerce",
                icon: (0, a.jsx)(h.Z, { className: "w-6 h-6 text-blue-600" }),
                colorBg: "bg-blue-100",
                tabs: [
                  {
                    title: "Orders",
              ...
              {
                name: "Healthcare",
                icon: (0, a.jsx)(p.Z, { className: "w-6 h-6 text-green-600" }),
              ...
              },
              {
                ...
                icon: (0, a.jsx)(v.Z, { className: "w-6 h-6 text-purple-600" }),
  ...
  function (e) {
    e.O(0, [676, 958, 648, 950, 920, 138, 78, 971, 23, 744], function () {
      return e((e.s = 93977));
    }),
      (_N_E = e.O());
  },
