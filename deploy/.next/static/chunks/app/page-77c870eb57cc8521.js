(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [931],
  {
    37394: function (e, t, a) {
      ...
      t.Z = function (e) {
        return o.createElement(
          ...
          s || (s = o.createElement("style", null, ".st0{fill:#ffba08}")),
          i ||
    ...
    98658: function (e, t, a) {
      Promise.resolve().then(a.bind(a, 24647));
    },
    24647: function (e, t, a) {
      "use strict";
      a.r(t),
        a.d(t, {
          default: function () {
      ...
      let A = (e) =>
        ...
        d = (e) => {
          let {
              badge: t = "Automation",
              title: a = "Impactful solutions and AI agents created",
              description:
                i = "Transform the way you work with our cutting-edge AI Development Services that are designed to streamline operations, automate repetitive tasks, and unlock deep insights for better decision-making.",
              emailPlaceholder: r = "Enter your email",
              submitEndpoint:
                c = "https://formsubmit.co/ajax/info@datatroops.io",
              buttonText: d = "Sign Up",
              submittedText: m = "Submitted",
              successMessage: h = "Thanks! We'll be in touch soon.",
              showPointers: u = !0,
            } = e,
            x = (0, n.useRef)(null),
            [g, p] = (0, n.useState)(!1),
            [f, y] = (0, n.useState)(0),
            [b, v] = (0, n.useState)({ x: 0, y: 0 }),
            [w, j] = (0, n.useState)(""),
            [N, B] = (0, n.useState)(""),
            [E, k] = (0, n.useState)(!1),
            C = (e) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.toLowerCase());
          (0, n.useEffect)(() => {
            let e = new IntersectionObserver(
              (e) => {
                p(e[0].isIntersecting);
              },
              { threshold: 0.05 },
            );
            ...
            let t = () => {
                ...
                let e = x.current.getBoundingClientRect(),
                  ...
                  a = -e.height;
                y(Math.max(0, Math.min(1, (t - e.top) / (t - a))));
              },
              a = (e) => {
                if (!x.current) return;
          ...
          let I = (e, t, a, s, i) => {
            let r = f * Math.PI * 2 + i;
            return { x: e + Math.cos(r) * a, y: t + Math.sin(r) * s };
          };
          (0, n.useEffect)(() => {
            function e() {
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  [void 0, void 0, void 0, void 0, void 0].map((e, t) => {
                    let a = 150 + 40 * t,
                      i = 100 + 30 * t,
                      r = I(50, 50, a / 10, a / 20, (Math.PI / 2.5) * t);
                    return (0, s.jsx)(
                      "div",
                      {
                        style: {
                ...
                children: [
                      ...
                      children: [
                        (0, s.jsx)("div", {
                          style: {
                            opacity: 0.7 + 0.3 * f,
                            transform: "rotate("
                              .concat(-15 * f, "deg) scale(")
                              .concat(1 + 0.2 * f, ")"),
                            filter: "hue-rotate(".concat(30 * f, "deg)"),
                          },
                          className:
                            o().dynamic([
                              ["a4b6d2ff32ac776a", [100 * Math.random() - 50]],
                          ...
                          children: (0, s.jsx)(A, { name: "AI-Agent" }),
                        }),
                        (0, s.jsx)("div", {
                          style: {
                            opacity: 0.7 + 0.3 * f,
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      (0, s.jsx)("div", {
                        style: {
                          transform: "translateY(".concat(g ? 0 : 20, "px)"),
                          opacity: g ? 1 : 0,
                      ...
                      (0, s.jsx)("h1", {
                        style: {
                          transform: "translateY(".concat(g ? 0 : 30, "px)"),
                          opacity: g ? 1 : 0,
                      ...
                      (0, s.jsx)("p", {
                        style: {
                          transform: "translateY(".concat(g ? 0 : 40, "px)"),
                          opacity: g ? 1 : 0,
                      ...
                      (0, s.jsxs)("form", {
                        style: {
                          transform: "translateY(".concat(g ? 0 : 50, "px)"),
                          opacity: g ? 1 : 0,
                          transitionDelay: "400ms",
                          boxShadow: "0 4px "
                            .concat(12 + 15 * f, "px rgba(139, 92, 246, ")
                            .concat(0.1 + 0.3 * f, ")"),
                          background:
                            "linear-gradient(135deg, var(--color-10002B)/"
                              .concat(0.03 + 0.05 * f, ", var(--color-240046)/")
                              .concat(0.08 + 0.05 * f, ")"),
                        },
                        onSubmit: M,
                        className:
      ...
      var g = a(66648),
        ...
        v = (e) => {
          let {
              ...
              imageSrc: i,
              category: r,
              categoryColor: o = "bg-purple-100 text-purple-700",
              isHighlighted: n = !1,
              url: l,
              animationDelay: A = 0,
            } = e,
          ...
          return (0, s.jsxs)(d, {
            ...
            transition: { duration: 0.5, delay: A },
            viewport: { once: !0 },
            className: (0, c.m6)(
              "rounded-3xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-all",
              n ? "col-span-1 sm:col-span-2 lg:col-span-3" : "col-span-1",
            ),
            children: [
              (0, s.jsx)("div", {
                ...
                children: (0, s.jsx)(g.default, {
                  ...
                  style: { height: n ? "300px" : "220px", maxHeight: "400px" },
                  unoptimized: !0,
                }),
              }),
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, s.jsx)("h2", {
                    ...
                    children: l
                      ? (0, s.jsx)(f.default, { href: l, children: t })
                      : (0, s.jsx)(
                          b.Z,
                      ...
                      children: l
                        ? (0, s.jsx)(f.default, {
                            ...
                            children: (0, s.jsxs)("span", {
                              className:
                                "block text-xs sm:text-sm font-medium flex items-center text-blue-500 hover:underline",
                              children: [
                                "Read More",
                                " ",
                                (0, s.jsx)(y.Z, {
                                  className:
                                    "inline-block ml-1 h-4 w-4 transition-transform duration-200 transform hover:translate-x-1",
                                }),
                              ],
                            }),
                          })
                        : (0, s.jsx)("span", {
                            className:
                              "block text-xs sm:text-sm font-medium text-gray-400",
        ...
        w = (e) => {
          ...
          let b = () => {
              g((e) => (e === l.length - 1 ? 0 : e + 1));
            },
            w = () => {
              g((e) => (0 === e ? l.length - 1 : e - 1));
            },
            j = (e) => {
              g(e);
            };
          ...
          let N = "grid-cols-"
            .concat(null == d ? void 0 : d.mobile, " sm:grid-cols-")
            .concat(null == d ? void 0 : d.tablet, " lg:grid-cols-")
            .concat(null == d ? void 0 : d.desktop);
          return (0, s.jsxs)("section", {
            className: "py-8 sm:py-12 px-4 ".concat(a),
            children: [
              (0, s.jsxs)("div", {
              ...
              (0, s.jsx)("div", {
                className: "".concat("max-w-".concat(A), " mx-auto"),
                children:
                  p && i
                    ? (0, s.jsxs)("div", {
                        className: "relative",
                    ...
                    : (0, s.jsx)("div", {
                        className: "grid ".concat(N, " gap-4 sm:gap-6"),
                        children: l.map((e, t) =>
                          (0, s.jsx)(
                            v,
                            { ...e, animationDelay: 0.1 * t },
                            e.id,
                          ),
                        ),
                      }),
      ...
      var I = (e) => {
          let {
              title: t = "DataTroops.ai Healthcare Assistance",
              subtitle: a = "Put your customer service on auto-pilot",
              description1:
                i = "We design and develop AI-powered solutions that automate workflows, uncover insights, and supercharge decision-making. From Generative AI to NLP and Computer Vision, our solutions are tailored to your goals and industry needs.",
              description2:
                r = "Effortlessly resolve repetitive customer queries with our no-code generative AI-powered chatbot that can be fine-tuned on your existing content.",
              description3:
                o = "Enhance your self-service resolution rate, reduce average handling time and cut down on operational cost with human-like conversations, powered by generative AI.",
              buttonText: l = "Book a Demo →",
              demoConversation: c = C,
            } = e,
            [A, d] = (0, n.useState)([]),
            [u, x] = (0, n.useState)(!1),
            f = (0, n.useRef)(null),
            ...
            [v, w] = (0, n.useState)(!1),
            [j, N] = (0, n.useState)(!1),
            [B, I] = (0, n.useState)(null),
            [M, L] = (0, n.useState)(""),
            [W, S] = (0, n.useState)(!1),
            [D, F] = (0, n.useState)({ email: "", phone: "", query: "" }),
            [G, Q] = (0, n.useState)(""),
            [R, T] = (0, n.useState)("");
          (0, n.useEffect)(() => {
          ...
          let H = () =>
            ...
            P = async () => {
              for (let e of (d([]), N(!0), c))
                "bot" === e.type &&
                  (x(!0), await new Promise((e) => setTimeout(e, 1500)), x(!1)),
                  Y({ type: e.type, text: e.text, time: H() }),
          ...
          let U = (e) =>
            ...
            Z = (e) => !e || /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e),
            z = (e) => !e || /^[0-9]{7,15}$/.test(e.replace(/[\s\-()+]/g, "")),
            V = (e) => {
              F((t) => ({ ...t, email: e })),
                Q(Z(e) ? "" : "Please enter a valid email address.");
            },
            O = (e) => {
              F((t) => ({ ...t, phone: e })),
                T(z(e) ? "" : "Please enter a valid phone number.");
            },
            X = () => (D.email.trim() || D.phone.trim()) && !G && !R,
            q = () => {
              !M.trim() ||
                j ||
                u ||
      ...
      var W = () => {
        let [e, t] = (0, n.useState)(0),
          a = L[e],
          i = () => t((e) => (0 === e ? L.length - 1 : e - 1)),
          r = () => t((e) => (e === L.length - 1 ? 0 : e + 1));
        return (0, s.jsx)("section", {
                                    ...
                                    (0, s.jsxs)("div", {
                                      ...
                                      children: [
                                        (0, s.jsx)("button", {
                                          onClick: i,
                                          className:
                                            "h-12 w-12 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors",
                                          children: (0, s.jsx)(m.G, {
                                            icon: h.acZ,
                                            className: "h-4 w-4",
                                          }),
      ...
      var D = (e) => {
          let { title: t, description: a, icon: i, href: r } = e,
            o = (0, s.jsxs)("div", {
              className:
          ...
          return r
            ...
            : (0, s.jsx)(b.Z, { message: "Coming Soon", children: o }, t);
        },
        F = () =>
          (0, s.jsx)("div", {
            className: "py-16 px-4",
                ...
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsx)("p", {
                      className: "mt-4 text-gray-300 max-w-3xl mx-auto",
                      children:
                        "At DataTroops.ai, we specialize in developing state-of-the-art AI solutions that accelerate operations, enhance decisions, and automate tasks across industries.",
                    }),
                  ],
                }),
                (0, s.jsx)("div", {
      ...
      T.displayName = Q.fC.displayName;
      let H = n.forwardRef((e, t) => {
        let { className: a, ...i } = e;
        return (0, s.jsx)(Q.Ee, {
          ref: t,
          className: R("h-full w-full object-cover", a),
          ...i,
        });
      });
      H.displayName = Q.Ee.displayName;
      ...
      Y.displayName = Q.NY.displayName;
      let P = (e) => {
        let { testimonial: t } = e;
        return (0, s.jsxs)("div", {
          className:
            "rounded-xl border border-[var(--color-7B2CBF)] bg-[var(--color-10002B)] text-white shadow-lg h-full flex flex-col justify-between p-8 md:p-10",
          children: [
            (0, s.jsx)(G.Z, {
              className: "text-[var(--color-E0AAFF)] h-12 w-12 mb-6",
            }),
            (0, s.jsxs)("p", {
              className:
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                (0, s.jsxs)(T, {
                  className: "mr-4",
                  children: [
                    (0, s.jsx)(H, { src: t.avatar, alt: t.author }),
                    (0, s.jsx)(Y, { children: t.initials }),
                  ],
                }),
                (0, s.jsxs)("div", {
                  children: [
      ...
      let Z = (e) => {
        ...
        V = () => {
          ...
          return (
            ...
            (0, s.jsx)("section", {
              className:
                "relative py-4 overflow-hidden bg-[var(--color-10002B)]",
              children: (0, s.jsxs)("div", {
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                        ...
                        children: z.map((t, a) =>
                          (0, s.jsx)(
                            p.E.div,
                            {
                              ...
                              children: (0, s.jsx)(P, { testimonial: t }),
                            },
                            t.id,
                          ),
                        ),
                        ...
                        children: z.map((a, i) =>
                          (0, s.jsx)(
                            "button",
                            {
                              ...
                              onClick: () => t(i),
                              "aria-label": "View testimonial ".concat(i + 1),
                            },
                            i,
                          ),
                        ),
                      ...
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          (0, s.jsx)(Z, { text: "99.9% Uptime" }),
                          (0, s.jsx)(Z, { text: "End-to-end encryption" }),
                          (0, s.jsx)(Z, { text: "24/7 Support" }),
                          (0, s.jsx)(Z, { text: "Cost Effective" }),
                        ],
                      }),
                    ],
                  }),
          ...
          (0, n.useEffect)(() => {
            let e = () => {
              ...
              let e = document.querySelectorAll("h2[id], h3[id]"),
                a = "";
              e.forEach((e) => {
                e.getBoundingClientRect().top <= 100 && (a = e.id);
              }),
                console.log("Current active section:", a);
            };
            return (
            ...
            children: [
              ...
              e &&
                (0, s.jsx)("button", {
                  ...
                  children: (0, s.jsx)(_.Z, { className: "h-5 w-5" }),
                }),
            ],
          })
        );
    ...
    87274: function (e, t, a) {
      ...
      t.Z = (e) => {
        let {
            ...
            buttonText: n = "Get Started",
            buttonLink: d = "#contact",
            image: m = c.Z,
          } = e,
          [h, u] = (0, i.useState)(!1);
  ...
  function (e) {
    e.O(
      0,
      [676, 699, 138, 648, 950, 164, 920, 59, 751, 381, 849, 971, 23, 744],
      function () {
        return e((e.s = 98658));
      },
    ),
